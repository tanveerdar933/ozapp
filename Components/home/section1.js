    ...
    <>
      <div className="form-bg">
        <div className="relative h-100">
              ...
              <div className="card-body p-0">
                <nav>
                  <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    <button
                      className="nav-link ride w-50 fs-15 fw-bold active"
                      id="nav-ride-tab"
                      data-bs-toggle="tab"
                    ...
                    <button
                      className="nav-link delivery w-50 fs-15 fw-bold"
                      id="nav-delivery-tab"
                      data-bs-toggle="tab"
                      ...
                      >
                        <div className="px-2 bg-transparent">
                          <div className="location_section">
                            <div
                              className="d-flex flex-row align-items-center card p-1 my-1 from"
                              style={{
                                color: "#333333",
                                fontSize: 12,
                                fontWeight: "500",
                            ...
                            <div
                              className="d-flex flex-row align-items-center card p-1 my-1 to"
                              style={{
                                color: "#333333",
                                fontSize: 12,
                                fontWeight: "500",
                            ...
                            <div
                              className="d-flex flex-row align-items-center card p-1 my-1 add_stop"
                              style={{
                        ...
                        <div>
                          <button className="w-100 rounded-bottom-3 text-dark fw-700 text-center bg-yellow">
                            Book Now
                          </button>
                        </div>
                      </div>
          ...
          <div className="d-lg-none d-block py-2 px-4">
