      ...
      <div className="home_section_2">
        ...
        <div className="container d-block d-lg-none">
          <div className="d-flex justify-content-evenly py-3">
            <div className="d-flex justify-content-between px-3 row w-100 mx-0">
              ...
              <div className="mob-section-2-img lead-mini d-flex justify-content-center align-items-center rounded px-1">
                <div className="d-flex flex-column align-items-center text-center">
                  <span className="text-white text-capitalize" style={{ fontSize: '6px' }}>Lead the pack and ride</span>
                  <span className="text-uppercase fw-bolder fs-12 text-yellow">Oz Ove</span>
                  <span className="text-white text-capitalize" style={{ fontSize: '6px' }}>Book for your group today</span>
                </div>
              </div>
            </div>
          </div>
